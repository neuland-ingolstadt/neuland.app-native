...
const AnnouncementCard = ({
	...
	return (
		<Pressable
			className="bg-card border border-border rounded-lg overflow-hidden mx-page my-1.5 w-auto"
		...
		>
			<View className="p-card">
				<View className="items-center flex-row gap-2.5">
					<View className="w-9 h-9 rounded-[18px] bg-primary-background justify-center items-center mr-1">
