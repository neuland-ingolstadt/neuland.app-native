	...
	return (
		...
		>
			...
			<Pressable
				...
				className="items-center self-center bg-card rounded-mg border-hairline border-border flex-row gap-2.5 justify-center my-section min-w-copy-button-min px-10 py-3"
