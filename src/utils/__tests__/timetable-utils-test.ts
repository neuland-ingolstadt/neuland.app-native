				...
				data: [
					{
						...
						enrollment: new Date('2023-09-01T08:00:00Z'),
						aids: ['Aid 1'],
						endDate: moment('2023-10-01T08:00:00Z').add(90, 'minutes').toDate(),
						eventType: 'exam'
					},
					{
						date: new Date('2023-10-01T10:00:00Z'),
				...
				data: [
					{
						...
						enrollment: new Date('2023-09-02T09:00:00Z'),
						aids: ['Aid 2'],
						endDate: moment('2023-10-02T09:00:00Z').add(90, 'minutes').toDate(),
						eventType: 'exam'
					},
					{
						date: new Date('2023-10-02T12:00:00Z'),
...
describe('convertTimetableToWeekViewEvents', () => {
	it('should convert timetable entries to calendar events', () => {
		...
		const result = convertTimetableToWeekViewEvents(entries, color, textColor);
		expect(result).toEqual(expectedOutput);
	});
});
